...
class UNet(nn.Module):
    ...
    def __init__(self, n_channels=3, n_classes=2, bilinear=False, base_features=64):
        ...
        features = [base_features * (2 ** i) for i in range(5)]  # [64, 128, 256, 512, 1024]
    ...
    def predict(self, x):
        """Get predicted class masks from input.
