"""GoNoGoNet model for surgical safety zone segmentation."""
...
class GoNoGoNet(nn.Module):
    """GoNoGoNet for Go/NoGo zone segmentation in cholecystectomy.
    
    This model segments surgical images into:
    - Background (0)
    - Go Zone / Safe to Incise (1)
    - NoGo Zone / Unsafe to Incise (2)
    """
    
    # Class definitions matching cholec_gonogo dataset
    ID2LABEL = {
        0: "Background",
        1: "Go Zone",  # Safe to Incise
        2: "NoGo Zone"  # Unsafe to Incise
    }
    ...
    def __init__(self, 
                 n_channels: int = 3,
                 n_classes: int = 3,  # Background, Go, NoGo
                 encoder_name: str = "resnet50",
                 encoder_weights: str = "imagenet",
                 activation: str = "softmax2d"):
        """Initialize GoNoGoNet.
        
        Args:
            n_channels: Number of input channels (3 for RGB)
            n_classes: Number of output classes (3: background, go, nogo)
    ...
    def load_from_checkpoint(cls, 
                           checkpoint_path: str,
                           device: str = 'cuda',
                           n_classes: int = 3) -> 'GoNoGoNet':
        """Load GoNoGoNet from checkpoint.
...
def load_gonogo_model(checkpoint_path: Optional[str] = None,
                      device: str = 'cuda') -> GoNoGoNet:
    """Load GoNoGoNet model with default checkpoint.
    ...
    return GoNoGoNet.load_from_checkpoint(checkpoint_path, device=device, n_classes=3)