...
echo "1. Quick test (5 samples, GPT-4o-mini only):"
...
echo "   EVAL_MODELS='gpt-4o-mini,claude-3-5-sonnet-20241022' python3 eval_pointing.py"
echo ""

echo "4. Combine options (20 samples, specific models):"
echo "   EVAL_NUM_SAMPLES=20 EVAL_MODELS='gpt-4o-mini,gemini-2.0-flash-exp' python3 eval_pointing.py"
echo ""
...
echo "main(num_samples=5, models=['gpt-4o-mini'])"
echo ""
echo "# Cell 3: Custom evaluation"
echo "main(num_samples=20, models=['gpt-4o-mini', 'claude-3-5-sonnet-20241022'])"
echo ""
