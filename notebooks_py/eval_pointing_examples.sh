...
echo "1. Quick test (5 samples, GPT-5-mini only):"
...
echo "   EVAL_MODELS='gpt-5-mini,claude-4-sonnet' python3 eval_pointing.py"
echo ""

echo "4. Combine options (20 samples, specific models):"
echo "   EVAL_NUM_SAMPLES=20 EVAL_MODELS='gpt-5-mini,gemini-2.5-pro' python3 eval_pointing.py"
echo ""
...
echo "main(num_samples=5, models=['gpt-5-mini'])"
echo ""
echo "# Cell 3: Custom evaluation"
echo "main(num_samples=20, models=['gpt-5-mini', 'claude-4-sonnet'])"
echo ""
