...
# ./eval_both_advanced.sh --samples 1 --models Qwen/Qwen2.5-VL-7B-Instruct --skip-cell
# echo "Evaluuating mistralai/Pixtral-12B-2409 Pointing"
# ./eval_both_advanced.sh --samples 1 --models mistralai/Pixtral-12B-2409 --skip-cell
