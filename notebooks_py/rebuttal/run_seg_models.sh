...
# Segmentation/Task-specific models
MODELS=("cholenet" "gonogonet")

echo "===== Running Seg/Task-Specific Models Evaluation ====="
echo "Models: ${MODELS[*]}"
echo "Splits: ${SPLITS[*]}"
echo "Seeds: ${SEEDS}"
...
for MODEL in "${MODELS[@]}"; do
    for SPLIT in "${SPLITS[@]}"; do
        LOG_FILE="${RESULTS}/logs/seg_models_${MODEL}_${SPLIT}_seeds.log"
...
echo ""
echo "===== Seg/Task-Specific Models Evaluation Complete ====="
echo "Results saved to: ${RESULTS}"
echo "Logs saved to: ${RESULTS}/logs/seg_models_*"
echo "========================================================="