...
echo "===== Running Local LVLMs Evaluation ====="
echo "Models: ${MODELS[*]}"
echo "Splits: ${SPLITS[*]}"
echo "Seeds: ${SEEDS}"
...
for MODEL in "${MODELS[@]}"; do
    for SPLIT in "${SPLITS[@]}"; do
        LOG_FILE="${RESULTS}/logs/local_lvmls_${MODEL}_${SPLIT}_seeds.log"
...
echo ""
echo "===== Local LVLMs Evaluation Complete ====="
echo "Results saved to: ${RESULTS}"
echo "Logs saved to: ${RESULTS}/logs/local_lvmls_*"
echo "==========================================="