...
echo "===== Running API LVLMs Evaluation ====="
echo "Models: ${MODELS[*]}"
echo "Splits: ${SPLITS[*]}"
echo "Seeds: ${SEEDS}"
...
for MODEL in "${MODELS[@]}"; do
    for SPLIT in "${SPLITS[@]}"; do
        LOG_FILE="${RESULTS}/logs/api_lvmls_${MODEL}_${SPLIT}_seeds.log"
...
echo ""
echo "===== API LVLMs Evaluation Complete ====="
echo "Results saved to: ${RESULTS}"
echo "Logs saved to: ${RESULTS}/logs/api_lvmls_*"
echo "========================================="