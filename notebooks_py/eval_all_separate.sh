...
./eval_both_advanced.sh --samples 1 --no-persistent --models llava-hf/llava-v1.6-mistral-7b-hf --skip-pointing
echo "Evaluating Qwen/Qwen2.5-VL-7B-Instruct Cell Selection"
./eval_both_advanced.sh --samples 1 --no-persistent --models Qwen/Qwen2.5-VL-7B-Instruct --skip-pointing
echo "Evaluuating mistralai/Pixtral-12B-2409 Cell Selection"
./eval_both_advanced.sh --samples 1 --no-persistent --models mistralai/Pixtral-12B-2409 --skip-pointing
...
./eval_both_advanced.sh --samples 1 --no-persistent --models llava-hf/llava-v1.6-mistral-7b-hf --skip-cell
echo "Evaluating Qwen/Qwen2.5-VL-7B-Instruct Pointing"
./eval_both_advanced.sh --samples 1 --no-persistent --models Qwen/Qwen2.5-VL-7B-Instruct --skip-cell
echo "Evaluuating mistralai/Pixtral-12B-2409 Pointing"
./eval_both_advanced.sh --samples 1 --no-persistent --models mistralai/Pixtral-12B-2409 --skip-cell
