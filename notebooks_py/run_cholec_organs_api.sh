...
# Run all 4 scenarios for API models on cholec_organs dataset

echo "Running all 4 scenarios for API models on CHOLEC_ORGANS dataset..."
echo
...
echo "All cholec_organs API evaluations complete!"
