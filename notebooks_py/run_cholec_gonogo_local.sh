...
# Run all 4 scenarios for local models on cholec_gonogo dataset

echo "Running all 4 scenarios for local models on CHOLEC_GONOGO dataset..."
echo
...
echo "All cholec_gonogo local evaluations complete!"
